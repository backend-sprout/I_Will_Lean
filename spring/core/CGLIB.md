...
* Hibernate는 자바빈 객체에 대한 프록시를 생성할 때 CGLIB를 사용     
...
`Java`의 클래스는 런타임에 동적으로 로드된다.(Dynamic Loading - [참고](https://www.youtube.com/watch?v=s-tXAHub6vg))       
`CGLIB`는 이러한 특징을 활용하여 이미 실행 중인 Java 프로그램에 프록시 클래스를 추가한다.         
